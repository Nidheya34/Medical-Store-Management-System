  ...
  l10.setBounds(470,220,200,25);
    ...
    l11.setBounds(470,260,250,25);
        ...
        try
		{
		    ...
		    con=DriverManager.getConnection("jdbc:mysql://localhost/medical_store","root","vaishnavi");
	   ...
	   try
	    {
			...
			Class.forName("com.mysql.jdbc.Driver");
		    con=DriverManager.getConnection("jdbc:mysql://localhost:3306/medical_store","root","vaishnavi");
			System.out.println("Connected to database.");
