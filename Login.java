...
class Login extends JFrame implements ActionListener
{
	...
	Login()
	{
		...
		b1 = new JButton("Login",new ImageIcon(getClass().getResource("images//Login.png")));
		b1.setBounds(200,400,100,35);
		jf.add(b1);b1.addActionListener(this);

		b2 = new JButton("Clear",new ImageIcon(getClass().getResource("images//clear.png")));
		b2.setBounds(320,400,100,35);
		jf.add(b2);b2.addActionListener(this);

		b3 = new JButton("Exit",new ImageIcon(getClass().getResource("images//exit.png")));
		...
		JLabel l=new JLabel("");
		Image  i=new ImageIcon(getClass().getResource("images//m1.png")).getImage();
